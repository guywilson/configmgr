                    ...
                    */
                    if (pszValue[0] == '<' && str_endswith(pszValue, ">")) {
                        ...
                        if (f == NULL) {
                            ...
                            throw cfg_error(cfg_error::buildMsg("ERROR reading config item file %s: %s", pszCfgItemFile, strerror(errno)), __FILE__, __LINE__);
                        }
                        ...
                        if (pszCfgItem == NULL) {
                            ...
                            throw cfg_error(cfg_error::buildMsg("Failed to allocate %ld bytes for config item %s", propFileLength + 1, pszKey), __FILE__, __LINE__);
                        }
